app.controller('WavLocPickingCtrl', ['$scope', 'WavePickService', 'LoginService', '$ionicLoading', 'LoadingService', '$rootScope', '$state', '$cordovaBarcodeScanner', '$ionicModal', '$cordovaToast',
    function ($scope, WavePickService, LoginService, $ionicLoading, LoadingService, $rootScope, $state, $cordovaBarcodeScanner, $ionicModal, $cordovaToast) {
        ...
        $scope.GeItemToPick = function () {
            ...
            WavePickService.GetWaveLocToPick($scope.loc, LoginService.userProfile.warehouseCode)
                .then(function (res) {

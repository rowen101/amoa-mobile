//Pallete Controller
app.controller('ReleasePalletelistCtrl', ['$scope', 'OrderReleaseService', '$state', '$rootScope', '$ionicModal', '$ionicHistory', 'LoadingService', '$ionicSideMenuDelegate','$cordovaToast', '$cordovaBarcodeScanner',
function ($scope, OrderReleaseService, $state, $rootScope, $ionicModal, $ionicHistory, LoadingService,$ionicSideMenuDelegate, $cordovaToast, $cordovaBarcodeScanner) {
...
//    $ionicSideMenuDelegate.canDragContent(false);
   ...
   /* $scope.showPickItemModal = function (palnum) {
    ...
    $scope.getPalleteList = function () {
         ...
         OrderReleaseService.getPalleteList()
            .then(function (res) {
                $scope.PalleteList = OrderReleaseService.PalleteList;
  ...
  /*  $scope.PickAll = function (palnum) {
    ...
    $scope.PickItem = function (palnum) {
       ...
       OrderReleaseService.CheckItem(palnum, $scope.pickDetail.lot, qtyLeft)
            .then(function (res) {
                $scope.moreInfoModal.hide();
                $scope.pickDetail = {};
